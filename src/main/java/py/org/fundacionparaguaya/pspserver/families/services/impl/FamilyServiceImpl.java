...
public class FamilyServiceImpl implements FamilyService {
    ...
    public FamilyServiceImpl(FamilyRepository familyRepository, FamilyMapper familyMapper, SurveyService surveyService) {
    ...
    public FamilyFileDTO getFamilyFileById(Long familyId) {
        ...
        FamilyDTO family = Optional.ofNullable(familyRepository.findOne(familyId)).map(familyMapper::entityToDto)
                .orElseThrow(() -> new UnknownResourceException("Family does not exist"));
