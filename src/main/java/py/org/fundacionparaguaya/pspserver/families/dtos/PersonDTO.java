...
public class PersonDTO {
	...
	private PersonDTO(Long personId, String firstName, String lastName, String identificationType,
			...
			String activitySecundary, String phoneNumber, CountryDTO countryOfBirth, CityDTO city, FamilyDTO family,
			String birthdate) {
	...
	public static class Builder {
		...
		public PersonDTO build() {
			return new PersonDTO(personId, firstName, lastName, identificationType, identificationNumber, personRole, gender,
					activityPrimary, activitySecundary, phoneNumber, countryOfBirth, city, family, birthdate);
		}
	...
	public String toString() {
		return MoreObjects.toStringHelper(this).add("personId", personId).add("name", firstName).add("lastname", lastName)
				.add("personRole", personRole).add("gender", gender).add("activityPrimary", activityPrimary)
				.add("activitySecundary", activitySecundary).add("phoneNumber", phoneNumber)
				.add("countryOfBirth", countryOfBirth.toString()).add("city", city.toString()).add("family", family.toString())
