...
public class ApplicationController {
    ...
    public ResponseEntity<ApplicationDTO> addApplication(
        ...
        ApplicationDTO result = applicationService
    ...
    public ResponseEntity<PaginableList<ApplicationDTO>> getAllApplicationsHubs(
        ...
        PageRequest pageRequest = new PspPageRequest(page, perPage, orderBy,
                sortBy);
        Page<ApplicationDTO> pageProperties = applicationService
                .listApplicationsHubs(pageRequest);
        PaginableList<ApplicationDTO> response = new PaginableList<>(
