...
import py.org.fundacionparaguaya.pspserver.psnetwork.services.UserApplicationService;
...
public class UserApplicationController {
	...
	@PostMapping()
	public ResponseEntity<UserApplicationEntityDTO> addUserApplication(@RequestBody UserApplicationEntityDTO userApplication) {
	...
	@PutMapping()
	public ResponseEntity<Void> updateUserApplication(@RequestBody UserApplicationEntityDTO userApplication) {
	...
	public ResponseEntity<UserApplicationEntityDTO> getUserApplication(@PathVariable("userApplicationId") Long userApplicationId) {
