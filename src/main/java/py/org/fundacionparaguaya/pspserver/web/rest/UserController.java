...
public class UserController {
    ...
    public ResponseEntity<UserDTO> addUserRoleApplication(
            ...
            @AuthenticationPrincipal UserDetailsDTO userDetails)
                                                    throws URISyntaxException {
        UserDTO result = userService.addUserWithRoleAndApplication(
                                                        userRoleApplicationDTO,
                                                        userDetails);
        return ResponseEntity
                .created(new URI("/api/v1/users/" + result.getUserId()))
                .body(result);
    ...
    public ResponseEntity<PaginableList<UserDTO>> getPaginatedUsers(
        ...
        Page<UserDTO> pageProperties =
                                userService.listUsers(pageRequest, userDetails);
        PaginableList<UserDTO> response =
