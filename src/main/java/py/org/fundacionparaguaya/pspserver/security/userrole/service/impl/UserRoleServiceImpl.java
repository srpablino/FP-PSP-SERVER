package py.org.fundacionparaguaya.pspserver.security.userrole.service.impl;
...
public class UserRoleServiceImpl implements UserRoleService {
	...
	@Override
	public ResponseEntity<UserRoleEntityDTO> addUserRole(UserRoleEntityDTO userRoleEntityDTO) {
		return new ResponseEntity<UserRoleEntityDTO>((UserRoleEntityDTO)
				convertToDto(userRoleRepository.save((UserRoleEntity)
				convertToEntity(userRoleEntityDTO, UserRoleEntity.class)), 
				UserRoleEntityDTO.class), 
				HttpStatus.CREATED);
	}

	@Override
	public ResponseEntity<UserRoleEntityDTO> getUserRoleById(Long userRoleId) {
		...
		if (userRoleEntity == null) {
			...
			return new ResponseEntity<UserRoleEntityDTO>(HttpStatus.NOT_FOUND);
		}
		logger.debug("Found User Role: " , userRoleEntity);
		return new ResponseEntity<UserRoleEntityDTO>((UserRoleEntityDTO)convertToDto(userRoleEntity, UserRoleEntityDTO.class), HttpStatus.OK);
	}
	...
	public ResponseEntity<List<UserRoleEntityDTO>> getAllUserRoles() {
		...
		if (userRoles.isEmpty()) {
			...
			return new ResponseEntity<List<UserRoleEntityDTO>>(HttpStatus.NO_CONTENT);
		}
		...
		return new ResponseEntity<List<UserRoleEntityDTO>>(convertToDtoList(userRoles, List.class), HttpStatus.OK);
	}
	...
	public ResponseEntity<Void> updateUserRole(UserRoleEntityDTO userRoleEntityDTO){
