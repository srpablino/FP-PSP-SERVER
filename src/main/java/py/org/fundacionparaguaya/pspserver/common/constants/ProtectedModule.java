...
public enum ProtectedModule implements ProtectableModule {
    ...
    ORGANIZATIONS {
        ...
        private String[] readRoles = {
                Role.ROLE_ROOT.getSecurityName(),
                Role.ROLE_USER.getSecurityName()
        };

        private String[] writeRoles = {
                Role.ROLE_ROOT.getSecurityName(),
                Role.ROLE_APP_ADMIN.getSecurityName(),
        ...
        @Override
        public String[] getReadRoles() {return readRoles;}

        @Override
        public String[] getWriteRoles() {return writeRoles;}
    ...
    SURVEYS {
        ...
        private String[] writeRoles = {
                Role.ROLE_ROOT.getSecurityName(),
                Role.ROLE_SURVEY_USER.getSecurityName(),
                Role.ROLE_APP_ADMIN.getSecurityName(),
                Role.ROLE_HUB_ADMIN.getSecurityName()
        };
